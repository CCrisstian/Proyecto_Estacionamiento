<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Ingreso_Reporte.aspx.cs" Inherits="Proyecto_Estacionamiento.Pages.Ingresos.Ingreso_Reporte" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="header-row">
        <h2>Reporte de Ingresos de Vehículos</h2>
    ...
    <div align="center">
        ...
        <rsweb:ReportViewer ID="rvIngresos" runat="server" Width="75%" Height="800px" 
